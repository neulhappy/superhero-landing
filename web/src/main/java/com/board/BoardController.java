...
public class BoardController extends HttpServlet {
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String pagingImg = BoardPage.pagingStr(totalCount, pageSize, blockPage, pageNum, contextPath + "/heroboard/list.do");
        ...
        req.getRequestDispatcher("/include/board_grid.jsp").include(req, resp);
